...
const AvailabilityBadge: React.FC<AvailabilityBadgeProps> = ({ location }) => {
  ...
  return (
    <div className="flex items-center space-x-2 text-sm pr-16 font-medium">
      <a href='mailto:artenanagara22@gmail.com' className="text-green-500 font-semibold hover:text-[#FFEB00] hover:-translate-x-2  hover:scale-110 transition duration-700 ease-in-out ">
